...
// 1. Add the SPI Register Definition Structure
typedef struct
{
...
// 2. Add SPI Base Addresses (APB2 Bus for SPI1)
#define SPI1_BASEADDR              (0x40013000U)

// 3. Add Peripheral Definitions (Cast base addresses to type pointers)
