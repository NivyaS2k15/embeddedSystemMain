...
clean-Src:
	-$(RM) ./Src/gpio_interrupt.cyclo ./Src/gpio_interrupt.d ./Src/gpio_interrupt.o ./Src/gpio_interrupt.su ./Src/main.cyclo ./Src/main.d ./Src/main.o ./Src/main.su ./Src/syscalls.cyclo ./Src/syscalls.d ./Src/syscalls.o ./Src/syscalls.su ./Src/sysmem.cyclo ./Src/sysmem.d ./Src/sysmem.o ./Src/sysmem.su
